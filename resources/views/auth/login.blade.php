            ...
            <div class="mt-2 relative">
                ...
                <button id="toggle-password" type="button" class="absolute inset-y-0 right-3 flex items-center text-gray-400 hover:text-gray-600">
                    <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-.274.977-.682 1.89-1.195 2.715m-2.437 2.066C16.553 17.577 14.376 19 12 19c-2.376 0-4.553-1.423-5.91-3.219m-2.437-2.066A9.969 9.969 0 012.458 12z" />
                    </svg>
                </button>
            </div>
    ...
    <script>
        document.getElementById('toggle-password').addEventListener('click', function() {
            ...
            if (passwordInput.type === 'password') {
                ...
                eyeIcon.setAttribute('d', "M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a10.05 10.05 0 01.947-2.192m1.49-2.427C5.447 6.423 7.624 5 12 5c4.477 0 8.268 2.943 9.542 7-.494.963-1.02 1.844-1.562 2.644m-2.55 2.358A9.969 9.969 0 0112 19c-2.376 0-4.553-1.423-5.91-3.219m2.437-2.066A3 3 0 0012 12m0 0a3 3 0 013 3m0-3a3 3 0 01-3-3m0 0a3 3 0 00-3-3");
            } else {
