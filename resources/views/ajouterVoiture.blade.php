<x-app-layout>
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <form method="POST" action="{{ route('voiture.store') }}" clas>
                @csrf
                ...
                <div>
                    ...
                    <x-text-input id="photo" class="block mt-1 w-full" type="file" name="photo" :value="old('photo')" autofocus autocomplete="photo" />
