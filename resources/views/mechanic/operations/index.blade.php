          ...
          <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
              ...
              <div>
                <form class="flex items-center w-full mx-auto">   
                  ...
                  <div class="w-full">
                      <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-500 block w-full ps-5 p-2.5" placeholder="Numero d'immatriculation" required />
                  </div>
