      ...
      <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
          ...
          <form method="POST" action="{{ route('paiperPersonnel.update',$papier->id) }}" class="space-y-6" enctype="multipart/form-data">
              ...
              <div>
                  ...
                  <x-file-input id="file_input" class="block mt-1 w-full" type="file" name="photo" :value="old('photo')  ?? $papier->photo" autofocus autocomplete="photo" accept="image/*" />
