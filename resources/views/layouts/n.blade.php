                                        ...
                                        <div class="flex items-center gap-4  px-6 py-4 text-sm border-b {{ $notification->read_at ? 'bg-gray-100' : 'bg-white' }}">
                                            ...
                                            <div class="flex-shrink-0">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.75 1.5C5.64137 1.5 1.5 5.64137 1.5 10.75C1.5 15.8586 5.64137 20 10.75 20C15.8586 20 20 15.8586 20 10.75C20 5.64137 15.8586 1.5 10.75 1.5ZM0 10.75C0 4.81294 4.81294 0 10.75 0C16.6871 0 21.5 4.81294 21.5 10.75C21.5 16.6871 16.6871 21.5 10.75 21.5C4.81294 21.5 0 16.6871 0 10.75ZM10.75 6C11.1642 6 11.5 6.33579 11.5 6.75V10.4393L13.7803 12.7197C14.0732 13.0126 14.0732 13.4874 13.7803 13.7803C13.4874 14.0732 13.0126 14.0732 12.7197 13.7803L10.2197 11.2803C10.079 11.1397 10 10.9489 10 10.75V6.75C10 6.33579 10.3358 6 10.75 6Z" fill="#BB0102" />
                                                </svg>
                                            </div>
                                            ...
                                            <a href="{{ route('notifications.markAsRead', $notification->id) }}" class="text-blue-500 hover:text-blue-700 text-xs">
                                                vu
                                            </a>
                                            @endif
                                        </div>
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
            <div class="flex-1 bg-white divide-y space-y-1">
                <ul class="space-y-2 font-medium pb-2">
                    ...
                    <li>
                        <a href="{{ route('voiture.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ms-3 capitalize">mes voiture</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('paiperPersonnel.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ms-3 capitalize">mes papiers personnels</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('voiture.create')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span class="ms-3 capitalize">ajouter une voiture</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('paiperPersonnel.create') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span class="ms-3 capitalize">ajouter un papier</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                            ...
                            <div class="ms-3 capitalize flex justify-between items-center">
